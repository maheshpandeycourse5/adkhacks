            ...
            <div className="rounded-xl border bg-white dark:bg-gray-800 text-card-foreground shadow-sm hover:shadow-md transition-all duration-200">
              <div className="p-6 flex flex-col space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-lg bg-blue-100 text-blue-800 px-2 py-0.5 rounded-md dark:bg-blue-900 dark:text-blue-100">
                    New
                  </span>
                </div>
            ...
            <div className="rounded-xl border bg-white dark:bg-gray-800 text-card-foreground shadow-sm hover:shadow-md transition-all duration-200">
              <div className="p-6 flex flex-col space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-lg bg-purple-100 text-purple-800 px-2 py-0.5 rounded-md dark:bg-purple-900 dark:text-purple-100">
                    Ready
                  </span>
                </div>
                <div className="flex items-center">
